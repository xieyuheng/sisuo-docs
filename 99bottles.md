...
``` sisuo-session
title: 1. Rediscovering Simplicity

prolog:
  message: 1. Rediscovering Simplicity
...
``` sisuo-session
title: 2. Test Driving Shameless Green

prolog:
  message: 2. Test Driving Shameless Green
...
``` sisuo-session
title: 3. Unearthing Concepts

prolog:
  message: 3. Unearthing Concepts
...
``` sisuo-session
title: 4. Practicing Horizontal Refactoring

prolog:
  message: 4. Practicing Horizontal Refactoring
...
``` sisuo-session
title: 5. Separating Responsibilities

prolog:
  message: 5. Separating Responsibilities
...
``` sisuo-session
title: 6. Achieving Openness

prolog:
  message: 6. Achieving Openness
...
``` sisuo-session
title: 7. Manufacturing Intelligence

prolog:
  message: 7. Manufacturing Intelligence
...
``` sisuo-session
title: 8. Developing a Programming Aesthetic

prolog:
  message: 8. Developing a Programming Aesthetic
...
``` sisuo-session
title: 9. Reaping the Benefits of Design

prolog:
  message: 9. Reaping the Benefits of Design
